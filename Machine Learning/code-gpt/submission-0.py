    ...
    class TransformerBlock(nn.Module):
        ...
        class MultiHeadedSelfAttention(nn.Module):
            ...
            def __init__(self, model_dim: int, num_heads: int):
                ...
                # REMOVE THIS LINE: self.output_proj = nn.Linear(model_dim, model_dim, bias=False)
            ...
            def forward(self, embedded: TensorType[float]) -> TensorType[float]:
                ...
                return concatenated  # Return directly, no extra projection
        ...
        def forward(self, embedded: TensorType[float]) -> TensorType[float]:
            torch.manual_seed(0)  # Add this for reproducibility
